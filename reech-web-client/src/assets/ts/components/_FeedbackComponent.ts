...
class FeedbackComponent {
  ...
  ///////////////////////
  public show = () => {
    if (EventHandlerUtil.trigger(this.element, 'reech.feedback.show') === false) {
      return
    }
    ...
    EventHandlerUtil.trigger(this.element, 'reech.feedback.shown')

    return this
  }

  public hide = () => {
    if (EventHandlerUtil.trigger(this.element, 'reech.feedback.hide') === false) {
      return
    }
    ...
    this.shown = false
    EventHandlerUtil.trigger(this.element, 'reech.feedback.hidden')
    return this
  }
