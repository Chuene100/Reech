...
class ToggleComponent {
  ...
  private _toggle = () => {
    ...
    EventHandlerUtil.trigger(this.element, 'reech.toggle.change')
    ...
    EventHandlerUtil.trigger(this.element, 'reech.toggle.changed')
    return this
  }
  ...
  private _enable = () => {
    ...
    EventHandlerUtil.trigger(this.element, 'reech.toggle.enable')
    ...
    EventHandlerUtil.trigger(this.element, 'reech.toggle.enabled')
    return this
  }
  ...
  private _disable = () => {
    ...
    EventHandlerUtil.trigger(this.element, 'reech.toggle.disable')
    ...
    EventHandlerUtil.trigger(this.element, 'reech.toggle.disabled')
    return this
  }
