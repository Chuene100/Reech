...
class StepperComponent {
  ...
  private _goTo = (index: number) => {
    EventHandlerUtil.trigger(this.element, 'reech.stepper.change')
    ...
    EventHandlerUtil.trigger(this.element, 'reech.stepper.changed')
  }
  ...
  private initHandlers = () => {
    this.btnNext?.addEventListener('click', (e: Event) => {
      ...
      EventHandlerUtil.trigger(this.element, 'reech.stepper.next', e)
    })

    this.btnPrev?.addEventListener('click', (e: Event) => {
      e.preventDefault()

      EventHandlerUtil.trigger(this.element, 'reech.stepper.previous', e)
    })
