...
class SearchComponent {
  ...
  private handlers(): void {
    ...
    if (this.menuObject) {
      ...
      if (this.toggleElement) {
        ...
        this.menuObject.on('reech.menu.dropdown.show', function () {
          // @ts-ignore
        ...
        this.menuObject.on('reech.menu.dropdown.hide', function () {
          // @ts-ignore
          if (isVisibleElement(context.toggleElement)) {
            // @ts-ignore
      ...
      this.menuObject.on('reech.menu.dropdown.shown', function () {
        // @ts-ignore
  ...
  public search = () => {
    if (!this.processing) {
      ...
      EventHandlerUtil.trigger(this.element, 'reech.search.process', this)
    }
  }
  ...
  // Clear
  public clear = () => {
    if (EventHandlerUtil.trigger(this.element, 'reech.search.clear') === false) {
      return
    }
    ...
    EventHandlerUtil.trigger(this.element, 'reech.search.cleared')
  }
