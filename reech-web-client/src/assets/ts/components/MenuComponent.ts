...
class MenuComponent {
  ...
  private _showDropdown = (item: HTMLElement) => {
    if (EventHandlerUtil.trigger(this.element, 'reech.menu.dropdown.show') === false) {
      return
    }
    ...
    EventHandlerUtil.trigger(this.element, 'reech.menu.dropdown.shown')
  }
  ...
  private _hideDropdown = (item: HTMLElement) => {
    if (EventHandlerUtil.trigger(this.element, 'reech.menu.dropdown.hide') === false) {
      return
    }
    ...
    EventHandlerUtil.trigger(this.element, 'reech.menu.dropdown.hidden')
  }
  ...
  private _showAccordion = (item: HTMLElement) => {
    if (EventHandlerUtil.trigger(this.element, 'reech.menu.accordion.show') === false) {
      return
    }
    ...
    if (subElement) {
      ...
      slideDown(sub, this.options.accordion.slideSpeed, () => {
        ...
        item.classList.add('show')
        sub.classList.add('show')
        EventHandlerUtil.trigger(this.element, 'reech.menu.accordion.shown')
      })
    }
  }

  private _hideAccordion = (item: HTMLElement) => {
    if (EventHandlerUtil.trigger(this.element, 'reech.menu.accordion.hide') === false) {
      return
    }
    ...
    if (sub) {
      slideUp(sub, this.options.accordion.slideSpeed, () => {
        ...
        EventHandlerUtil.trigger(this.element, 'reech.menu.accordion.hidden')
      })
    }
  }
  ...
  private _link = (element: HTMLElement, e: Event) => {
    if (EventHandlerUtil.trigger(this.element, 'reech.menu.link.click') === false) {
      return
    }

    // Dismiss all shown dropdowns
    MenuComponent.hideDropdowns(undefined)
    EventHandlerUtil.trigger(this.element, 'reech.menu.link.clicked')
  }
