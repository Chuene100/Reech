    ...
    if (reverse === true) {
      ...
      if (st > offsetNum && this.lastScrollTop < st) {
        ...
        if (this.eventTriggerState === true) {
          EventHandlerUtil.trigger(this.element, 'reech.sticky.on')
          EventHandlerUtil.trigger(this.element, 'reech.sticky.change')
        ...
        if (this.eventTriggerState === false) {
          EventHandlerUtil.trigger(this.element, 'reech.sticky.off')
          EventHandlerUtil.trigger(this.element, 'reech.sticky.change')
