...
class DrawerComponent {
  ...
  private _toggle = () => {
    if (EventHandlerUtil.trigger(this.element, 'reech.drawer.toggle') === false) {
      return
    }
    ...
    EventHandlerUtil.trigger(this.element, 'reech.drawer.toggled')
  }

  private _hide = () => {
    if (EventHandlerUtil.trigger(this.element, 'reech.drawer.hide') === false) {
      return
    }
    ...
    EventHandlerUtil.trigger(this.element, 'reech.drawer.after.hidden')
  }

  private _show = () => {
    if (EventHandlerUtil.trigger(this.element, 'reech.drawer.show') === false) {
      return
    }
    ...
    EventHandlerUtil.trigger(this.element, 'reech.drawer.shown')
  }
