...
//customs
import {
  reechRecommendationVideo,
  suggestedHowToChannelData,
  recommendedHowToVideosData,
} from "../../assets/data/howTo/howToVideoData";
import { COLORS, icons, images } from "../../constants";

const HowToChannelScreen = () => {
  const [moreModal, setMoreModal] = useState(false);

  const item = reechRecommendationVideo;
  ...
  //render recommend video section
  function renderRecommendVideoItem() {
    return (
      <>
        <Video
          ref={videoRef}
          ...
          source={{
            uri: "https://player.vimeo.com/external/391645328.sd.mp4?s=25d2bee5592fa242a228591d1df9c955df9ad87f&profile_id=164&oauth2_token_id=57447761",
          }}
          ...
          selectedAudioTrack={{
            type: "mp4",
            value:
              "https://player.vimeo.com/external/391645328.sd.mp4?s=25d2bee5592fa242a228591d1df9c955df9ad87f&profile_id=164&oauth2_token_id=57447761",
          }}
  ...
  function renderVideoDescriptionItems() {
    return (
      <>
  ...
  //play and see more section
  function renderTouchableActionsSection() {
    return (
      <>
        {/*empty placeholder*/}
        <Text>
        ...
        <View style={styles.innerModalContainer}>
          ...
          <View style={styles.userVideoDetailsContainer}>
            <ImageBackground
              ...
              style={styles.gradientColorContainerHowToChannel}
            >
              <Image
                source={{ uri: item[0].userAccountImage }}
  ...
  function renderScreenItemListSection() {
    return (
      <View style={styles.videoItemContainer}>
        {renderRecommendVideoItem()}

        {/*title & action section*/}
        <View style={styles.actionContainer}>
          {renderVideoDescriptionItems()}

          {/*screen play content section*/}
          <View style={styles.actionOptions}>
            {renderTouchableActionsSection()}
  ...
  function renderChannelRecommendationsSection() {
    return (
      <>
        ...
        <FlatList
          horizontal
          data={suggestedHowToChannelData}
  ...
  function renderWatchedVideoRecommendationSection() {
    return (
      <>
        <Text style={styles.categoryText}>
          Because you watched a video on nikon camera
        </Text>

        <FlatList
          horizontal
          data={recommendedHowToVideosData}
          keyExtractor={(item, index) => index.toString()}
          showsHorizontalScrollIndicator={false}
          renderItem={({ item }) => {
            return (
      ...
      <View style={styles.iconSections}>
        ...
        <Pressable
          onPress={() => [
            status.isPlaying
              ? videoRef.current.pauseAsync()
              : navigation.navigate("HowToAddVideoScreen"),
          ]}
        >
        ...
        {/*show channels image*/}
        <Pressable
          onPress={() => navigation.navigate("HowToChannelCategoryScreen")}
        >
  ...
  function renderScrollableSection() {
    return (
      ...
      >
        ...
        {renderWatchedVideoRecommendationSection()}
...
const styles = StyleSheet.create({
  ...
  gradientColorContainerHowToChannel: {
  ...
  addModalActionContainer: {
    marginTop: 20,
    flexDirection: "column",
  },
  addModalActionContent: {
    flexDirection: "row",
    justifyContent: "flex-start",
    alignItems: "center",
    marginBottom: 20,
  },
  addModalActionTextContainer: {
    flexDirection: "column",
    marginLeft: 14,
  },
  addModalActionTextItem: {
    color: COLORS.white,
    fontSize: 16,
    fontFamily: "PoppinsBold",
    marginBottom: 4,
  },
  addModalActionSubTextItem: {
    color: COLORS.darkGray,
    fontSize: 12,
    fontFamily: "PoppinsLight",
    marginBottom: 4,
...
export default HowToChannelScreen;
