...
const ThoughtSingleChannelCategoryScreen = ({ route }) => {
  ...
  return (
    <SafeAreaView style={styles.screenContainer}>
      ...
      <View>
        ...
        >
          {item?.channelId?.channel === "Arts"
            ? renderArtsChannelList()
            : item?.channelId?.channel === "Business"
              ? renderBusinessListData()
              : item?.channelId?.channel === "Comedy"
                ? renderComedyListData()
                : item?.channelId?.channel === "The Environment"
                  ? renderEnvironmentListData()
                  : item?.channelId?.channel === "Engineering"
                    ? renderEngineeringChannelList()
                    : item?.channelId?.channel === "Fashion, Hair & Beauty"
                      ? renderFashionChannelList()
                      : item?.channelId?.channel === "Food & Beverage"
                        ? renderFoodChannelList()
                        : item?.channelId?.channel === "Health & Wellness"
                          ? renderHealthChannelList()
                          : item?.channelId?.channel === "Kids & Family"
                            ? renderKidsChannelList()
                            : item?.channelId?.channel === "Law & Politics"
                              ? renderLawChannelList()
                              : item?.channelId?.channel === "Life"
                                ? renderLifeChannelList()
                                : item?.channelId?.channel === "Music & Entertainment" || item?.channelId?.channel === "Entertainment"
                                  ? renderMusicChannelList()
                                  : item?.channelId?.channel === "Religious"
                                    ? renderReligionChannelList()
                                    : item?.channelId?.channel === "Science & Technology"
                                      ? renderScienceChannelList()
                                      : item?.channelId?.channel === "Space and Building"
                                        ? renderSpaceChannelList()
                                        : item?.channelId?.channel === "Sport & Recreation"
                                          ? renderSportChannelList()
                                          : item?.channelId?.channel === "Transport"
                                            ? renderTransportChannelList()
                                            : item?.channelId?.channel === "Travel & Hospitality"
                                              ? renderTravelChannelList()
                                              : item?.channelId?.channel === "Other"
...
export default ThoughtSingleChannelCategoryScreen;
