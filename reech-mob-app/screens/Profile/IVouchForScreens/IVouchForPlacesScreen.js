...
import { FlatList, Image, TouchableOpacity, StyleSheet, View, Text, Platform, ImageBackground } from "react-native";
import { useNavigation } from "@react-navigation/native";
import { TextInput } from "react-native";
import { FontAwesome } from "@expo/vector-icons";

//import customs
import { userAccountPlacesData } from "../../../assets/data/VouchForData";
import { COLORS, images } from "../../../constants";
import { EmptyFlatlistComponent } from "../../../components";

const IVouchForPlacesScreen = () => {
  const navigation = useNavigation();

  //state handler
  const [vouchData, setVouchData] = useState(userAccountPlacesData);
  const [isFetching, setIsFetching] = useState(false);

  //a method used to filter data according to the username
  const searchBusiness = (text) => {
    let filteredData = userAccountPlacesData.filter(
      (x) =>
  ...
  const fetchData = () => {
    setVouchData(userAccountPlacesData);
    setIsFetching(false);
  };
  const onRefresh = () => {
    setIsFetching(true);
        ...
        <View style={styles.innerSearchContainer}>
          <View style={styles.textInputContainer}>
            <TextInput
              ...
              style={styles.inputScreenFilters}
    ...
    return (
      <>
        <View style={styles.filterSectionContainer}>
          <TouchableOpacity
            onPress={() => navigation.navigate("IVouchForFIlterScreen")}
                      ...
                      <View style={styles.imageItemContainer}>
                        ...
                        >
                          <ImageBackground
                            ...
                            style={styles.gradientColorContainerPlacesIVouch}
                          >
                            <Image
  ...
  return (
    <View style={styles.contentContainerIVouchFor}>
...
const styles = StyleSheet.create({
  ...
  gradientColorContainerPlacesIVouch: {
    width: 80,
    height: 80,
    justifyContent: "center",
    alignItems: "center",
...
export default IVouchForPlacesScreen;
