...
const VouchedForFIlterScreen = () => {
  ...
  function renderHeaderSection() {
    return (
      <View style={styles.contentContainerFilterPlaces}>
              ...
              <View style={styles.innerSearchContainer}>
                <View style={styles.textInputContainer}>
                  <TextInput
                    ...
                    style={styles.inputFilterVouched}
...
export default VouchedForFIlterScreen;
