...
import { ExpressiveNavigation } from "../../../../../Navigations";
import NavHeader from "@/components/Headers/NavHeader";

const ExpressiveAccountScreen = () => {
  //header section
    ...
    return (
      <View style={styles.headerContainer}>
        ...
        <View style={styles.bgImageContainer}>
          <Image source={{ uri: images.s3 }} style={styles.bgImageItem} />
          <View style={styles.bgTextContainer}>
            <Text style={styles.bgTextItem}>Expressive</Text>
          </View>
        </View>
      </View>
    );
...
export default ExpressiveAccountScreen;
