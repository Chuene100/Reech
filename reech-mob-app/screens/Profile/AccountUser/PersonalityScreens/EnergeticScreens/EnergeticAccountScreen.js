...
import { EnergeticNavigation } from "../../../../../Navigations";
import NavHeader from "@/components/Headers/NavHeader";

const EnergeticAccountScreen = () => {
  //header section
    ...
    return (
      <View style={styles.headerContainer}>
        ...
        <View style={styles.bgImageContainer}>
          <Image source={{ uri: images.s1 }} style={styles.bgImageItem} />
          <View style={styles.bgTextContainer}>
            <Text style={styles.bgTextItem}>Energetic</Text>
          </View>
        </View>
      </View>
    );
...
export default EnergeticAccountScreen;
