...
//customs
import { energeticPeopleData } from "../../../../../assets/data/personalityData/socialData";
import { COLORS, images } from "../../../../../constants";
import { EmptyFlatlistComponent } from "../../../../../components";

const EnergeticPeopleScreen = () => {
  //state handlers
  const [itemCollection, setItemCollection] = useState(energeticPeopleData);
  ...
  const searchUser = (text) => {
    let filteredData = energeticPeopleData.filter(
      (x) =>
...
export default EnergeticPeopleScreen;
