...
import { TextInput, Image, StyleSheet, Text, View, ImageBackground, Platform } from "react-native";
import { FlatList } from "react-native-gesture-handler";
import { FontAwesome } from "@expo/vector-icons";

//customs
import { socialPlacesData } from "../../../../../assets/data/personalityData/socialData";
import { COLORS, images } from "../../../../../constants";
import { EmptyFlatlistComponent } from "../../../../../components";

const PersonalitySocialPlacesScreen = () => {
  //state handlers
  const [itemCollection, setItemCollection] = useState(socialPlacesData);
  ...
  const searchPlaces = (text) => {
    let filteredData = socialPlacesData.filter(
      (x) =>
                ...
                <View style={styles.placesContent}>
                  ...
                  <View style={styles.placeImageContainer}>
                    <ImageBackground
                      ...
                      style={styles.gradientColorContainerPersonality}
                    >
                      <Image
...
const styles = StyleSheet.create({
  ...
  gradientColorContainerPersonality: {
...
export default PersonalitySocialPlacesScreen;
