...
//customs
import { socialPeopleData } from "../../../../../assets/data/personalityData/socialData";
import { COLORS, images } from "../../../../../constants";
import { EmptyFlatlistComponent } from "../../../../../components";

const PersonalitySocialPeopleScreen = () => {
  //state handlers
  const [itemCollection, setItemCollection] = useState(socialPeopleData);
  ...
  const searchUser = (text) => {
    let filteredData = socialPeopleData.filter(
      (x) =>
...
export default PersonalitySocialPeopleScreen;
