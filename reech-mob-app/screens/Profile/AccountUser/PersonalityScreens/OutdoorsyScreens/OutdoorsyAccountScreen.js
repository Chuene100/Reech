...
import { OutdoorsyNavigation } from "../../../../../Navigations";
import NavHeader from "@/components/Headers/NavHeader";

const OutdoorsyAccountScreen = () => {
  //header section
    ...
    return (
      <View style={styles.headerContainer}>
        ...
        <View style={styles.bgImageContainer}>
          <Image source={{ uri: images.s4 }} style={styles.bgImageItem} />
          <View style={styles.bgTextContainer}>
            <Text style={styles.bgTextItem}>Outdoorsy</Text>
          </View>
        </View>
      </View>
    );
...
export default OutdoorsyAccountScreen;
