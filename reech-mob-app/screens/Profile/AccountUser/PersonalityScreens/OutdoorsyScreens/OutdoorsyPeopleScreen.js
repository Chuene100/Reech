...
import { TextInput, Image, ImageBackground, StyleSheet, Text, View, Platform } from "react-native";
import { FlatList } from "react-native-gesture-handler";
import { FontAwesome } from "@expo/vector-icons";

//customs
import { outDoorsyPeopleData } from "../../../../../assets/data/personalityData/socialData";
import { COLORS, images } from "../../../../../constants";
import { EmptyFlatlistComponent } from "../../../../../components";

const OutdoorsyPeopleScreen = () => {
  //state handlers
  const [itemCollection, setItemCollection] = useState(outDoorsyPeopleData);
  ...
  const searchUser = (text) => {
    let filteredData = outDoorsyPeopleData.filter(
      (x) =>
                        ...
                        <View style={styles.sharedBubbleMateImageContainer}>
                          {item.sharedBubbleMates.map((bubbleMates, i) => (
                            ...
                            >
                              {i < 3 && (
                                <Image
                                  source={{ uri: bubbleMates.bubbleMateImage }}
...
export default OutdoorsyPeopleScreen;
