...
//customs
import { outdoorsyPlacesData } from "../../../../../assets/data/personalityData/socialData";
import { COLORS, images } from "../../../../../constants";
import { EmptyFlatlistComponent } from "../../../../../components";

const OutdoorsyPlacesScreen = () => {
  //state handler
  const [itemCollection, setItemCollection] = useState(outdoorsyPlacesData);
  ...
  const searchPlaces = (text) => {
    let filteredData = outdoorsyPlacesData.filter(
      (x) =>
                ...
                <View style={styles.placesContent}>
                  ...
                  <View style={styles.placeImageContainer}>
                    <ImageBackground
                      ...
                      style={styles.gradientColorContainerOutdoorsy}
                    >
                      <Image
...
const styles = StyleSheet.create({
  ...
  gradientColorContainerOutdoorsy: {
...
export default OutdoorsyPlacesScreen;
