...
//customs
import { reflectivePlacesData } from "../../../../../assets/data/personalityData/socialData";
import { COLORS, images } from "../../../../../constants";
import { EmptyFlatlistComponent } from "../../../../../components";

const ReflectivePlacesScreen = () => {
  //state handlers
  const [itemCollection, setItemCollection] = useState(reflectivePlacesData);
  ...
  const searchPlaces = (text) => {
    let filteredData = reflectivePlacesData.filter(
      (x) =>
                ...
                <View style={styles.placesContent}>
                  ...
                  <View style={styles.placeImageContainer}>
                    <ImageBackground
                      ...
                      style={styles.gradientColorContainerReflective}
                    >
                      <Image
...
const styles = StyleSheet.create({
  ...
  gradientColorContainerReflective: {
...
export default ReflectivePlacesScreen;
