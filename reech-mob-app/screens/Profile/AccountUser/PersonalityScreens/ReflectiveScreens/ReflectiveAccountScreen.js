...
import { ReflectiveNavigation } from "../../../../../Navigations";
import NavHeader from "@/components/Headers/NavHeader";

const ReflectiveAccountScreen = () => {
  //header section
    ...
    return (
      <View style={styles.headerContainer}>
        ...
        <View style={styles.bgImageContainer}>
          <Image source={{ uri: images.s2 }} style={styles.bgImageItem} />
          <View style={styles.bgTextContainer}>
            <Text style={styles.bgTextItem}>Reflective</Text>
          </View>
        </View>
      </View>
    );
...
export default ReflectiveAccountScreen;
