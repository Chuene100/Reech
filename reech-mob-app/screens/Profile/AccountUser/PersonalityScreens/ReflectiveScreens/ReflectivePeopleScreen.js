...
//customs
import { reflectivePeopleData } from "../../../../../assets/data/personalityData/socialData";
import { COLORS, images } from "../../../../../constants";
import { EmptyFlatlistComponent } from "../../../../../components";

const ReflectivePeopleScreen = () => {
  //state handlers
  const [itemCollection, setItemCollection] = useState(reflectivePeopleData);
  ...
  const searchUser = (text) => {
    let filteredData = reflectivePeopleData.filter(
      (x) =>
...
export default ReflectivePeopleScreen;
