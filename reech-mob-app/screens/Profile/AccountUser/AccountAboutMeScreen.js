...
import { FontAwesome5, Fontisto, Entypo, Octicons } from "@expo/vector-icons";
...
const AccountAboutMeScreen = ({ route }) => {
  ...
  const { data: user, error: fetchError, isLoading } = useReadUserQuery(userId ?? null);
    ...
    return (
      ...
      >
        ...
        <View style={styles.coverImageContainer}>
          <Image
            source={
              user?.coverImage ? { uri: image[user?.coverImage] } : images.bg
            }
            style={styles.imageCoverItem}
          />
        </View>
    ...
    return (
      ...
      >
        ...
        <View style={styles.myLifeTopScrollSection}>
          ...
          <Text style={styles.userBlurbTextItem}>
...
export default AccountAboutMeScreen;
