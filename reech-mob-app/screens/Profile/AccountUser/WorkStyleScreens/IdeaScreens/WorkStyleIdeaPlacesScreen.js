...
//customs
import { ideaOrientedPlacesData } from "../../../../../assets/data/personalityData/workStyleData";
import { COLORS, images } from "../../../../../constants";
import { EmptyFlatlistComponent } from "../../../../../components";

const WorkStyleIdeaPlacesScreen = () => {
  //state handler
  const [itemCollection, setItemCollection] = useState(ideaOrientedPlacesData);
  ...
  const searchPlaces = (text) => {
    let filteredData = ideaOrientedPlacesData.filter(
      (x) =>
                ...
                <View style={styles.placesContent}>
                  ...
                  <View style={styles.placeImageContainer}>
                    <ImageBackground
                      ...
                      style={styles.gradientColorContainerWorkPlaces}
                    >
                      <Image
...
const styles = StyleSheet.create({
  ...
  gradientColorContainerWorkPlaces: {
...
export default WorkStyleIdeaPlacesScreen;
