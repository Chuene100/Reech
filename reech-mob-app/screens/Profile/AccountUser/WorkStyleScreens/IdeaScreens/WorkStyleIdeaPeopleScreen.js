...
//customs
import { ideaOrientedPeopleData } from "../../../../../assets/data/personalityData/workStyleData";
import { COLORS, images } from "../../../../../constants";
import { EmptyFlatlistComponent } from "../../../../../components";

const WorkStyleIdeaPeopleScreen = () => {
  //state handler
  const [itemCollection, setItemCollection] = useState(ideaOrientedPeopleData);
  ...
  const searchUser = (text) => {
    let filteredData = ideaOrientedPeopleData.filter(
      (x) =>
...
export default WorkStyleIdeaPeopleScreen;
