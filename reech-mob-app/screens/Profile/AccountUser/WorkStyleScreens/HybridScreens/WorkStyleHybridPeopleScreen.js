...
//customs
import { hybridPeopleData } from "../../../../../assets/data/personalityData/workStyleData";
import { COLORS, images } from "../../../../../constants";
import { EmptyFlatlistComponent } from "../../../../../components";

const WorkStyleHybridPeopleScreen = () => {
  //state handlers
  const [itemCollection, setItemCollection] = useState(hybridPeopleData);
  ...
  const searchUser = (text) => {
    let filteredData = hybridPeopleData.filter(
      (x) =>
...
export default WorkStyleHybridPeopleScreen;
