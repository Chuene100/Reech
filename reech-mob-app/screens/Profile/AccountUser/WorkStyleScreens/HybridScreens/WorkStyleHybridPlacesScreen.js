...
//customs
import { hybridPlacesData } from "../../../../../assets/data/personalityData/workStyleData";
import { COLORS, images } from "../../../../../constants";
import { EmptyFlatlistComponent } from "../../../../../components";

const WorkStyleHybridPlacesScreen = () => {
  //state handler
  const [itemCollection, setItemCollection] = useState(hybridPlacesData);
  ...
  const searchPlaces = (text) => {
    let filteredData = hybridPlacesData.filter(
      (x) =>
        ...
        <View style={styles.textInputContainer}>
          <View style={styles.inputIconContainer}>
            <TextInput
              ...
              style={styles.inputHybridPlaces}
                ...
                <View style={styles.placesContent}>
                  ...
                  <View style={styles.placeImageContainer}>
                    <ImageBackground
                      ...
                      style={styles.gradientColorContainerWork}
                    >
                      <Image
...
export default WorkStyleHybridPlacesScreen;
