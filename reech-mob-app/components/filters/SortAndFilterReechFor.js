...
const SortAndFilterReechFor = ({ sort, onSort, onFilter }) => {
  const {
    control,
    handleSubmit,
    reset
  ...
  return (
    <View style={styles.headerFilterSectionContainer}>
      ...
      <TouchableOpacity
        ...
        style={styles.headerSortContent}
      >
        <Text style={styles.headerFilterText}>Sort{"     "}</Text>
      ...
      <TouchableOpacity
        ...
        style={styles.headerFilterContent}
      >
      ...
      >
        ...
        <View style={styles.innerSortModalContainer}>
          ...
          <ScrollView
            ...
            nestedScrollEnabled={true}
            style={[styles.moreOptionContent, { marginBottom: 20 }]}
          >
            {/*experience option*/}
            <View style={[styles.sortItem, { marginTop: 20 }]}>
            ...
            {/*location option*/}
            <View style={[styles.sortItem, { marginTop: 20, zIndex: 99 }]}>
              <View style={styles.sortIcon}>
                <Entypo name="location" size={25} color={COLORS.purple} />
              </View>
            ...
            {/*rate option*/}
            <View style={[styles.sortItem, { marginTop: 60, zIndex: -99 }]}>
              <View style={[styles.sortIcon, { marginTop: -45 }]}>
                <Fontisto name="money-symbol" size={25} color={COLORS.purple} />
              </View>
              <View style={styles.sortTextContainer}>
            ...
            {/*submit button, Added a filter button to be able to submit the data to the homescreen*/}
...
export default SortAndFilterReechFor;
