...
const LatestProfileModal = ({ isModalVisible, closeModal }) => {
  ...
  return (
    ...
    >
      <ImageBackground source={icons?.popupBg} style={styles.profileModalContainer}>
                    ...
                    >
                      <View style={styles.profileItem}>
                        {item?._id === current_profile?._id ? (
                          ...
                          >
                            <View style={styles.profileIconActive}>
                              <Image
                                source={
                                  item?.profileImage
                                    ? {
...
export default LatestProfileModal;
